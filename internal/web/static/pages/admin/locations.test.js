...
const fixtureHtml = `<!doctype html>
    <html>
        <body>
            ...
            <div id="window-modal" class="hidden">
                <div id="modal-windows-list"></div>
                <button id="add-window-button"></button>
                <form id="window-form">
...
describe('admin/locations', () => {
    ...
    it('renders a Check Windows button for each event row', () => {
        ...
        expect(buttons[0].getAttribute('onclick')).toBe('openCheckWindowsModal(1)');
        expect(buttons[1].getAttribute('onclick')).toBe('openCheckWindowsModal(2)');
    });
    ...
    it('renders a Check Windows button for an event even when it has no locations', () => {
        ...
        const button = window.document.querySelector('[onclick="openCheckWindowsModal(1)"]');
    ...
    it('opens the check windows modal and renders windows for the event', async () => {
        ...
        await window.openCheckWindowsModal(1);
        ...
        expect(listHtml).toContain('Monday 09:00 - Monday 12:00 (America/Chicago)');
